...
@WebServlet("/page/communityInformation/list")
public class HouseCommunityServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<CommunityInformation> communityInformationList = communityInformationService.queryCommunityInformation();
