    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div id="showImg" ><img src="${car.photo}" width="80px" height="80px"></div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">
                <span class="we-red">*</span>车辆颜色
            </label>
            <div class="layui-input-inline">
                <input type="text" name="carColor" id="carColor" autocomplete="off" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item">
            <label  class="layui-form-label">
                <span class="we-red">*</span>车辆牌照
            </label>
            <div class="layui-input-inline">
    ...
    layui.use([ 'jquery','form'], function() {
        ...
        form.on('submit(save)',function (data) {
            ...
            $.ajax({
                ...
                url: "update",
                async:false,
                data: "id="+data.field.id+ "&photo="+data.field.photo+"&memberName="+data.field.memberName + "&carColor="+data.field.carColor+"&carNumber="+data.field.carNumber+"&note="+data.field.note,
                dataType:'json',
